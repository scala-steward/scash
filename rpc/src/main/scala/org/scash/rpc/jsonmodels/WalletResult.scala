...
import org.scash.core.crypto.{ DoubleSha256DigestBE, ECPublicKey, RipeMd160Digest, Sha256Hash160Digest }
...
case class MultiSigResult(address: BitcoinAddress, redeemScript: ScriptPubKey) extends WalletResult
