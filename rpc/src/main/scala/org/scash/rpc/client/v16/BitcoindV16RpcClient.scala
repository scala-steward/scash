...
class BitcoindV16RpcClient(override val instance: BitcoindInstance)(
  ...
  private def signRawTransaction(
      ...
      sigHash: Option[SigHashType]): Future[SignRawTransactionResult] = {
    ...
    val params =
      List(JsString(transaction.hex),
           utxos,
           jsonKeys,
           Json.toJson(sigHash.getOrElse(SigHashType.bchALL)))
  ...
  def signRawTransaction(
      ...
      sigHash: SigHashType): Future[SignRawTransactionResult] =
