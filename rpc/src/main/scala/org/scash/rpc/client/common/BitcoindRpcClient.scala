...
import org.scash.rpc.config.{ BitcoindConfig, BitcoindInstance }
 ...
 * or
 * [[org.scash.rpc.client.v17.BitcoindV17RpcClient BitcoindV17RpcClient]].
 *
 * If a RPC call fails for any reason, a
 * [[org.scash.rpc.BitcoindException BitcoindException]] is thrown.
