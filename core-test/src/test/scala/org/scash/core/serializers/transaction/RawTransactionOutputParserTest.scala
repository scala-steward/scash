...
import org.scash.core.protocol.transaction.{ EmptyTransactionOutput, TransactionOutput }
import org.scash.core.script.bitwise.OP_EQUAL
import org.scash.core.script.constant.{ BytesToPushOntoStack, ScriptConstant }
