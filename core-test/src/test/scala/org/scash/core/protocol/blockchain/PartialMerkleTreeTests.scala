...
import org.scash.core.bloom.{ BloomFilter, BloomUpdateAll }
import org.scash.core.crypto.DoubleSha256Digest
import org.scash.core.number.UInt32
import org.scash.core.util.{ BitcoinSUtil, Leaf, Node }
...
class PartialMerkleTreeTests extends FlatSpec with MustMatchers {
  ...
  it must "correctly compute a merkle tree that has an odd amount of txids on the merkle tree" in {
    ...
    //https://travis-ci.org/bitcoin-s/scash/builds/205812075#L2774
