...
import org.scash.core.script.constant.{ BytesToPushOntoStack, OP_0, ScriptConstant }
...
class P2SHScriptSignatureTest extends FlatSpec with MustMatchers {
  ...
  it must "correctly parse a EscrowTimeoutScriptSig and it's redeem script" in {
