...
import org.scash.core.script.locktime.OP_CHECKSEQUENCEVERIFY
import org.scash.core.script.reserved.{ OP_RESERVED, OP_VER }
import org.scash.core.script.result.{ ScriptErrorInvalidStackOperation, ScriptErrorOpReturn }
import org.scash.core.script.stack.OP_DROP
