...
import org.scash.core.script.crypto.OP_CHECKMULTISIGVERIFY
import org.scash.core.script.flag.{ ScriptFlag, ScriptVerifyMinimalData }
import org.scash.core.script.result.{ ScriptErrorBadOpCode, ScriptErrorMinimalData }
