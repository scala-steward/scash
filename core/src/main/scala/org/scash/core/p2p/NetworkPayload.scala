...
import org.scash.core.crypto.{ DoubleSha256Digest, HashDigest }
...
import org.scash.core.serializers.p2p.messages._
import org.scash.core.util.{ BitcoinSUtil, Factory }
import org.scash.core.wallet.fee.{ SatoshisPerByte, SatoshisPerKiloByte }
...
sealed trait NetworkPayload extends NetworkElement {
   ...
   * This is generally used to build a [[org.scash.core.p2p.NetworkHeader]]
   */
 ...
 *
 * @param merkleBlock The actual [[org.scash.core.protocol.blockchain.MerkleBlock MerkleBlock]] that this message represents
 */
...
object VersionMessage extends Factory[VersionMessage] {
  ...
  def apply(socket: InetSocketAddress, network: NetworkParameters): VersionMessage =
