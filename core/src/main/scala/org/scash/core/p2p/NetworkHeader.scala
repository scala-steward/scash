...
import org.scash.core.serializers.p2p.headers.RawNetworkHeaderSerializer
...
object NetworkHeader extends Factory[NetworkHeader] {
  ...
  /**
    * Creates a network header from it's [[org.scash.core.config.NetworkParameters NetworkParameters]] and [[NetworkPayload]]
    * @param network the [[org.scash.core.config.NetworkParameters NetworkParameters]] object that indicates what network the payload needs to be sent on
