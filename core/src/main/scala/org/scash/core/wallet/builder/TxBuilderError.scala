...
/**
 * Represents an error that can be returned by the [[org.scash.core.wallet.builder.TxBuilder]]
...
object TxBuilderError {
  ...
  /**
   * Means that you are using the wrong [[org.scash.core.wallet.signer.Signer]] to
   * sign the given [[org.scash.core.protocol.script.ScriptPubKey]]
   */
   ...
   * inside of the [[org.scash.core.protocol.script.P2SHScriptPubKey]]
   */
  ...
  /**
   * Means that you passed the wrong public key for a [[org.scash.core.protocol.script.P2PKHScriptPubKey]] that you are trying to spend
   */
  ...
  /**
   * Can occurr when we are trying to sign a [[org.scash.core.protocol.script.P2SHScriptPubKey]] but
  ...
  /** We cannot have a [[org.scash.core.protocol.script.P2SHScriptPubKey]] nested inside of another spk   */
  val NestedP2SHSPK = Failure(new IllegalArgumentException("We cannot sign nested P2SHScriptPubKeys"))

  /**
   * Means that there is no signer defined for the given [[org.scash.core.protocol.script.ScriptPubKey]] type.
   */
  ...
  val MissingDestinationOutput = Failure(
    new IllegalArgumentException("Lost a transaction output in the signing process")
  )
  ...
  /**
   * Indicates we are spending multiple [[org.scash.core.protocol.script.CLTVScriptPubKey]],
  ...
  val OutputBelowDustThreshold = Failure(
    new IllegalArgumentException(
